...
public class PurchaseController {
  ...
  @GetMapping
  public ApiResponse<List<PurchaseResponse>> getPurchases(CustomUserDetails userDetails,
  ...
  @PostMapping
  public ApiResponse<PurchaseResponse> createPurchase(CustomUserDetails userDetails,@RequestBody PurchaseCreateRequest request) {
    String userName = userDetails.getUsername();
    return ApiResponse.success(purchaseService.createPurchase(userName, request));
  }
